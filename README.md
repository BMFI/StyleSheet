...
Special note: notice the Inline style quote and citation of referece in the 10th paragraph second to last sentence which is acceptable using BMFI StyleSheet for Computer Science Located at(https://www.bmfi.github/ATS). Also, find example of web page citations at: (https://bmfi.github.io/TinDog/).
